...
public class Kasir {
    ...
    public void tampilkanDaftarMeja() {
        ...
        for (Meja meja : daftarMeja) {
            System.out.println("Meja " + meja.getNomorMeja() + " - " + (meja.isKosong() ? "Kosong" : "Ada Pelanggan"));
        }
        System.out.println();
    }
    ...
    public void tambahPelanggan(int nomorMeja, Pelanggan pelanggan) {
        Meja targetMeja = daftarMeja[nomorMeja - 1];
        if (targetMeja.isKosong()) {
            targetMeja.setPelanggan(pelanggan);
            // Update the Meja object in the daftarMeja array
            daftarMeja[nomorMeja - 1] = targetMeja;
    ...
    public void tambahPesanan(int nomorMeja, Menu menu) {
        ...
        System.out.println(menu.getNama() + " telah ditambahkan ke Meja " + nomorMeja);
        System.out.println();
    }
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    if (totalHarga == 0) {
                        System.out.println("Meja " + nomorMejaHitungHarga + " belum memesan apapun.");
                    } else {
